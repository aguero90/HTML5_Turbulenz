...
var Morph = (function () {
    function Morph() {
        ...
        this.remainingAttributes = ["ATTR1", "ATTR3", "ATTR9"];
    }
    //
    // addShapes
    //
    Morph.prototype.addShapes = function (morphShapes) {
        var result = false;
    ...
    //
    Morph.prototype.generateSemanticsNames = function (shapes) {
    ...
    Morph.prototype.getShapeCount = function () {
...
var MorphInstance = (function () {
    ...
    // clone
    //
    MorphInstance.prototype.clone = function () {
    ...
    // setNode
    //
    MorphInstance.prototype.setNode = function (node) {
        if (this.node) {
    ...
    // getNode
    //
    MorphInstance.prototype.getNode = function () {
        return this.node;
    };
    ...
    // setMaterial
    //
    MorphInstance.prototype.setMaterial = function (material) {
    ...
    // getMaterial
    //
    MorphInstance.prototype.getMaterial = function () {
    ...
    // getWorldExtents
    //
    MorphInstance.prototype.getWorldExtents = function () {
    ...
    //
    MorphInstance.prototype.addCustomWorldExtents = function (customWorldExtents) {
    ...
    //
    MorphInstance.prototype.removeCustomWorldExtents = function () {
        this.worldExtentsUpdate = -1;
        this.node.renderableWorldExtentsRemoved();
    };
    ...
    //
    MorphInstance.prototype.getCustomWorldExtents = function () {
    ...
    //
    MorphInstance.prototype.hasCustomWorldExtents = function () {
    ...
    //
    MorphInstance.prototype.prepareDrawParameters = function (drawParameters) {
    ...
    // generateSemantics
    //
    MorphInstance.prototype.generateSemantics = function (graphicsDevice, semanticsNames) {
        var cachedSemantics = this.cachedSemantics;
        var semanticsHash = semanticsNames.join();
        var semantics = cachedSemantics[semanticsHash];
        if (!semantics) {
    ...
    MorphInstance.prototype.setWeights = function (weights) {
        this.techniqueParameters['morphWeights'] = weights;
    };

    MorphInstance.registerEffects = //
    // registerEffects
    //
    function (mathDevice, renderer, shaderManager, effectManager) {
    ...
    MorphInstance.create = //
    // Constructor function
    //
    function (morph, sharedMaterial) {
