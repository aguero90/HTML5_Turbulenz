...
TurbulenzEngine.onload = function onloadFn() {
    ...
    var userDataError = function userDataErrorFn(errorMsg, status, errorMethod) {
    ...
    var loadingLoop = function loadingLoopFn() {
        if (sceneLoader.complete()) {
            ...
            camera.lookAt(center, worldUp, mathDevice.v3Build(center[0] + extent[0] * 2 * cameraDistanceFactor, center[1] + extent[1] * cameraDistanceFactor, center[2] + extent[2] * 2 * cameraDistanceFactor));
