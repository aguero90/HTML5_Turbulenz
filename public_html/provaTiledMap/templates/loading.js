...
TurbulenzEngine.onload = function onloadFn() {
    ...
    buttonsAvailable = buttonLoadDuck && buttonRemoveDuck && buttonLoadWatercan && buttonRemoveWatercan && buttonCreateWatercanInstance && buttonRemoveWatercanInstance;
    ...
    var update = function updateFn() {
        ...
        if (graphicsDevice.beginFrame()) {
            renderer.draw(graphicsDevice, clearColor, drawExtraDecals, drawExtraTransparent, drawDebug);
    ...
    var loadingLoop = function loadingLoopFn() {
        if (sceneLoader.complete()) {
            ...
            if (!textureManager.isTextureMissing(loadingScreenImage) && textureManager.isTextureLoaded(loadingScreenImage)) {
