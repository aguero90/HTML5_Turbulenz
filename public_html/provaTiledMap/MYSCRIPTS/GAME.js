...
Game.prototype = {
    ...
    reset: function () {
        ...
        this.world.addRigidBody(this._createPlatform(5, 5, 15, 5.5));
        this.world.addRigidBody(this._createPlatform(20, 8, 30, 8.5));
        this.world.addRigidBody(this._createPlatform(0, 11, 7, 11.5));
        this.world.addRigidBody(this._createPlatform(12, 12, 20, 12.5));
        this.world.addRigidBody(this._createPlatform(2, 18, 10, 18.5));
        this.world.addRigidBody(this._createPlatform(18, 18, 25, 18.5));
