        ...
        fn: function () {
            if (reverb && reverbSlot) {
                if (reverbOn) {
                    ...
                    reverbOn = !(duck1SoundSource.setAuxiliarySendFilter(0, null, null) && duck2SoundSource.setAuxiliarySendFilter(0, null, null));
                } else {
                    // Set the reverb effect slot on auxiliary send at index 0, no filter
                    reverbOn = (duck1SoundSource.setAuxiliarySendFilter(0, reverbSlot, null) && duck2SoundSource.setAuxiliarySendFilter(0, reverbSlot, null));
                }
            }
            return reverbOn;
        }
        ...
        fn: function () {
            if (echo && echoSlot) {
                if (echoOn) {
                    ...
                    echoOn = !(duck1SoundSource.setAuxiliarySendFilter(1, null, null) && duck2SoundSource.setAuxiliarySendFilter(1, null, null));
                } else {
                    // Set the reverb effect slot on auxiliary send at index 1, no filter
                    echoOn = (duck1SoundSource.setAuxiliarySendFilter(1, echoSlot, null) && duck2SoundSource.setAuxiliarySendFilter(1, echoSlot, null));
                }
            }
            return echoOn;
        }
        ...
        fn: function () {
            if (lowPassFilter) {
                if (lowPassOn) {
                    ...
                    lowPassOn = !(duck1SoundSource.setDirectFilter(null) && duck2SoundSource.setDirectFilter(null));
                } else {
                    // Set no filter on direct output only
                    lowPassOn = (duck1SoundSource.setDirectFilter(lowPassFilter) && duck2SoundSource.setDirectFilter(lowPassFilter));
                }
            }
            return lowPassOn;
        }
