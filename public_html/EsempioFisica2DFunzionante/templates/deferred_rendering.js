...
TurbulenzEngine.onload = function onloadFn() {
    ...
    var renderFrame = function renderFrameFn() {
        ...
        if (graphicsDevice.beginFrame()) {
            ...
            if (renderer.updateBuffers(graphicsDevice, rendererBufferWidth, rendererBufferHeight)) {
                ...
                renderer.draw(graphicsDevice, clearColor, drawExtraDecalsFn, drawExtraTransparentFn, drawDebugFn, postEffects.getEffectSetupCB("copy"));
            }
    ...
    var loadAssets = function loadAssets() {
        ...
        renderer = DeferredRendering.create(graphicsDevice, mathDevice, shaderManager, effectManager, { shadowRendering: true });
